...
public class DefaultArtifactTransforms implements ArtifactTransforms {
    ...
    private class ArtifactTransformingVisitor implements ArtifactVisitor {
        ...
        public void visitArtifact(final ResolvedArtifact artifact) {
            ...
            if (transform == null) {
                if (artifactTransformRegistrations.areMatchingAttributes(artifactAttributes, this.attributes)) {
            ...
            try {
                for (File file : files) {
                    try {
                        ...
                        if (transform == null) {
                            if (artifactTransformRegistrations.areMatchingAttributes(fileWithAttributes, attributes)) {
                                result.add(file);
                                continue;
                            }
                            continue;
